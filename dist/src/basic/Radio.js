...
return(
_react2.default.createElement(_reactNative.TouchableOpacity,_extends({ref:function ref(c){return _this2._root=c;}},this.prepareRootProps(),{__source:{fileName:_jsxFileName,lineNumber:29}}),
...
style:{
color:_reactNative.Platform.OS==='ios'?this.props.selected?variables.brandPrimary:undefined:
